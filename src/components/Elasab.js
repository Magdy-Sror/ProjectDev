                        ...
                        <div className='col-md-6'>
                            <div className='row drRow'>
                                ...
                                <div className='col-md-8'>
                                    <h4 className="text-primary">دكتور  أمير حامد   </h4>
                                    <h6>  أخصائي مخ وأعصاب   </h6>
                                    <Star/>
                                    <h6>التقييم العام من 5 زوار للدكتور</h6>

                                    <ul>
                                        <li className="mt-4">دكتور : مخ وأعصاب    </li>
                                        <li className="mt-4">الكشف :  60 جنية</li>
                        ...
                        <div className='col-md-6'>
                            ...
                            <Carousel responsive={responsive} className='mb-3'>
                                ...
                                <div class="card ms-5 mt-5  rounded h-auto">
                                    ...
                                    <p class="card-text text-center mt-5 mb-5 fs-5"> من 2.00 م <br /> حتي 9.00 م </p>
                        ...
                        <div className='col-md-6'>
                            <div className='row drRow'>
                                ...
                                <div className='col-md-8'>
                                    ...
                                    <h6>   استشاري أوعية دموية   </h6>
                                    <Star/>
                                    <h6>التقييم العام من 5 زوار للدكتور</h6>

                                    <ul>
                                        <li className="mt-4">دكتور : أوعية دموية    </li>
                        ...
                        <div className='col-md-6'>
                            ...
                            <Carousel responsive={responsive} className='mb-3'>
                                ...
                                <div class="card ms-5 mt-5  rounded h-auto">
                                    ...
                                    <p class="card-text text-center mt-5 mb-5 fs-5"> من 1.00 م <br /> حتي 5.00 م </p>
