        ...
        <div className="schools-details">
          <div className="container">
               ...
               <div className="top">
                 ...
                 <div>
                     <div className="shownSchool">مدرسة رأس الخليج </div>
                 </div>
               ...
               <div className="row">
                    <div className="col-md-6 mt-4">
                        <div className="card">
                        <span className="school-name">مدرسه رأس الخليج </span>
                            <div className="row">
                    ...
                    <div className="col-md-6 mt-4">
                        ...
                        <span className="school-name">مدرسه رأس الخليج </span>
                            <div className="row">
                                ...
                                <div className="col-8">
                                <ul className="list-unstyled info-list">
                                    <li><b>الأسم : </b>محمود النبوي الشرصي</li>
                                    <li><b>المادة المدرسية : </b> دراسات</li>
                                    <Star/>
                                    <li><b>التقييم العام : </b>من 10 زوار للمدرسة</li>
                                    <li><b>مرحلة التدريس : </b>المرحلة الأبتدائية</li>
                                </ul>
