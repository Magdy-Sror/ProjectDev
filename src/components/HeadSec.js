          ...
          <div className="container">
               ...
               <div className="row">
                    <div className="col-md-6 mt-4">
                        <div className="card">
                        <span className="school-name">رأس الخليج ثانوي</span>
                            <div className="row">
                                ...
                                <ul className="list-unstyled info-list">
                                    <li><b>الأسم : </b> محمد عبد الخالق</li>
                    ...
                    <div className="col-md-6 mt-4">
                        ...
                        <span className="school-name">رأس الخليج ثانوي</span>
                            <div className="row">
                                ...
                                <div className="col-8">
                                <ul className="list-unstyled info-list">
                                    <li><b>الأسم : </b> حمدي محمد زرع</li>
                                    <li><b>المادة المدرسية : </b>اللغة الفرنسية</li>
                                    <Star/>
                                    <li><b>التقييم العام : </b>من 10 زوار للمدرسة</li>
                                    <li><b>مرحلة التدريس : </b>المرحلة الأبتدائية</li>
                                </ul>
                        ...
                        <span className="school-name">رأس الخليج ثانوي</span>
                            <div className="row">
                                ...
                                <ul className="list-unstyled info-list">
                                    ...
                                    <li><b>المادة المدرسية : </b>التاريخ</li>
                                    <Star/>
                                    <li><b>التقييم العام : </b>من 10 زوار للمدرسة</li>
                                    <li><b>مرحلة التدريس : </b>المرحلة الأبتدائية</li>
                                </ul>
