          ...
          <div className="container">
               ...
               <div className="row">
                    <div className="col-md-6 mt-4">
                        <div className="card">
                        <span className="school-name">مدرسة ممدوح ابو النجا </span>
                            <div className="row">
                    ...
                    <div className="col-md-6 mt-4">
                        ...
                        <span className="school-name">مدرسة ممدوح ابو النجا </span>
                            <div className="row">
                                ...
                                <div className="col-8">
                                <ul className="list-unstyled info-list">
                                    <li><b>الأسم : </b> محمود شتا</li>
                                    <li><b>المادة المدرسية : </b>العلوم</li>
                                    <Star/>
                                    <li><b>التقييم العام : </b>من 10 زوار للمدرسة</li>
                                    <li><b>مرحلة التدريس : </b>المرحلة الأبتدائية</li>
                                </ul>
