          ...
          <div className='col-md-6'>
            <div className='row drRow'>
              ...
              <div className='col-md-8'>
                <h4 className="text-primary">دكتور اسلام عبد النبي</h4>
                <h6>اخصائي امراض الجلديه</h6>
                <Star/>
                <h6>التقييم العام من 5 زوار للدكتور</h6>

                <ul>
                  <li className="mt-4">دكتور : جلدبة  </li>
        ...
        <div className='row'>
          <div className='col-md-6'>
            <div className='row drRow'>
              ...
              <div className='col-md-8'>
                <h4 className="text-primary">اسلام عبد النبي</h4>
                <h6>اخصائي امراض الجلديه</h6>
                <Star/>
                <h6>التقييم العام من 5 زوار للدكتور</h6>

                <ul>
                  <li className="mt-4">دكتور : جلدية  </li>
                  <li className="mt-4">الكشف :  70 جنية</li>
                  <li className="mt-4">الاماكن : مركز طب راس الخليج</li>
                </ul>
              </div>
            </div>
        ...
        <div className='row'>
          <div className='col-md-6'>
            <div className='row drRow'>
              ...
              <div className='col-md-8'>
                <h4 className="text-primary"> محمد فضل</h4>
                <h6>اخصائي امراض الجلديه</h6>
                <Star/>
                <h6>التقييم العام من 5 زوار للدكتور</h6>
