          ...
          <div className='col-md-6'>
            <div className='row drRow'>
              ...
              <div className='col-md-8'>
                <h4 className="text-primary">دكتور محسن الشافعي</h4>
                <h6>اخصائي امراض الرئه</h6>
                <Star/>
                <h6>التقييم العام من 5 زوار للدكتور</h6>

                <ul>
                  <li className="mt-4">دكتور : صدر  </li>
        ...
        <div className='row'>
          <div className='col-md-6'>
            <div className='row drRow'>
              ...
              <div className='col-md-8'>
                <h4 className="text-primary">دكتور ابراهيم ابو الفتوح</h4>
                <h6>اخصائي امراض الرئه</h6>
                <Star/>
                <h6>التقييم العام من 5 زوار للدكتور</h6>

                <ul>
                  <li className="mt-4">دكتور : صدر وحساسيه  </li>
                  <li className="mt-4">الكشف :  40 جنية</li>
                  <li className="mt-4">الاماكن : مركز طب راس الخليج</li>
                </ul>
              </div>
