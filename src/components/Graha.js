            ...
            <div className='col-md-6'>
              <div className='row drRow'>
                ...
                <div className='col-md-8'>
                  <h4 className="text-primary">دكتور أشرف الصعيدي</h4>
                  <h6>   أخصائي جراحة عامة </h6>
                  <Star/>
                  <h6>التقييم العام من 5 زوار للدكتور</h6>

                  <ul>
                    <li className="mt-4">دكتور : جراحة عامة  </li>
            ...
            <div className='col-md-6'>
              ...
              <Carousel responsive={responsive} className='mb-3'>
                ...
                <div class="card ms-5 mt-5  rounded h-auto">
                  ...
                  <p class="card-text text-center mt-5 mb-5 fs-5"> من 6.00 م <br /> حتي 10.00 م </p>
